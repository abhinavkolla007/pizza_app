...
//     if (isNaN(stock)) return alert("Invalid stock number");
//     try {
...
//         <input
//           placeholder="Type (base, sauce, etc)"
//           value={newItem.type}
...
//                 <td style={{ color: item.stock < item.threshold ? "red" : "green" }}>
...
//                     style={{ width: "60px" }}
//                   />
//                   <button onClick={() => handleUpdateStock(item._id)}>Update</button>
//                 </td>
//                 <td>
...
//                   <strong>Veggies:</strong> {order.veggies.join(", ")}<br />
//                   <strong>Meat:</strong> {order.meat.join(", ")}
//                 </td>
//                 <td>{order.status}</td>
//                 <td>
//                   <select
