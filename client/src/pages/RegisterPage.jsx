...
// pizza-app/client/src/pages/RegisterPage.jsx
...
export default function RegisterPage() {
  ...
  // Refs for password inputs to toggle readOnly
  const passwordRef = useRef(null);
  const confirmPasswordRef = useRef(null);

  // Set inputs to readOnly initially to prevent autofill on load
  // and then enable them on focus
  const handlePasswordFocus = (e) => {
    e.target.readOnly = false; // Enable input
    e.target.style.boxShadow = "0 0 0 2px #6a11cb33"; // Apply focus style
  };

  const handlePasswordBlur = (e) => {
    e.target.readOnly = true; // Set back to readOnly
    e.target.style.boxShadow = ""; // Remove focus style
  };

  // On component mount, ensure inputs are readOnly
  useEffect(() => {
