...
//         <div>
//           <label>Sauce:</label>
//           <select value={sauce} onChange={(e) => setSauce(e.target.value)} required>
...
//               }}
//             >
//               <strong>Pizza:</strong> {order.base}, {order.sauce}, {order.cheese}
//               <br />
//               <strong>Veggies:</strong> {order.veggies.join(", ") || "None"}
//               <br />
